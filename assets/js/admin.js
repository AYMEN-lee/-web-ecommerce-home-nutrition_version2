...
(function () {
  ...
  function renderEditor() {
    ...
    modalBody.innerHTML =
      ...
      '<div class="field-grid">' +
        ed("name_ar", "Product Name (Arabic)", d.name_ar, "مثال: كرياتين أحادي الهيدرات", false, "rtl") +
        ed("brand_ar", "Brand (Arabic)", d.brand_ar, "مثال: أوستروفيت", false, "rtl") +
      '</div>' +
      ed("tagline_ar", "Tagline (Arabic)", d.tagline_ar, "سطر قصير بالعربية", true, "rtl") +
      '<div class="field full"><label>Description (Arabic)</label>' +
